...
COMMON_REGRESSION_CASE_STUDIES+=sapic-embedded-msr-binding.spthy sapic-msr-call-binding-reuse.spthy
...
case-studies$(SUBDIR)regression/trace/sapic-embedded-msr-binding_analyzed.spthy: TRACE_EXTRA_ARGS=--quit-on-warning
